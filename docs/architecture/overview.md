...
- `projects`: proyectos administrativos, participaciones históricas del padrón, scopes contextuales históricos de cuentas `project_manager` y Project Activities con lifecycle terminal; dominio y aplicación representan referencias por IDs/read models mínimos sin importar Identity, Auth, Volunteers ni perfiles.
