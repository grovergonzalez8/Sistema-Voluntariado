...
- Proyectos: `list_projects`, `get_project_detail`, `create_project`, `update_project`, `close_project`, `list_project_assignments`, `search_project_volunteer_candidates`, `assign_volunteer_to_project`, `finish_project_volunteer_assignment`, `list_volunteer_projects`, `list_project_manager_assignments`, `search_project_manager_candidates`, `assign_project_manager`, `finish_project_manager_assignment`, `list_project_activities`, `get_project_activity_detail`, `create_project_activity`, `update_project_activity`, `complete_project_activity`, `cancel_project_activity`.
