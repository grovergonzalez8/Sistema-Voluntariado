...
| Concurrencia Projects/Activities/Participation/Attendance | cuatro harness versionados vía `pnpm projects:test:concurrency`     | después de pgTAP y antes de Functions/E2E | sesiones `psql` independientes en DB local | rollback, cierre de sesiones y eliminación de fixtures en `finally` |
