...
| TD-008 | Scope coordinator basado solo en actor origen         | Projects V1 usa `project.manage` global; no hay scopes contextuales aprobados | modelar scopes de negocio en otro ExecPlan  |
