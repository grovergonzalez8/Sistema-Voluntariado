...
Estas personas describen necesidades, no inventan identidades ni políticas organizacionales.

| Persona                  | Necesidad inicial                                          | Riesgo principal                                |
| ------------------------ | ---------------------------------------------------------- | ----------------------------------------------- |
...
| Responsable de proyecto  | Gestionar Projects asignados, participaciones y Activities | Confundir scope contextual con autoridad global |
...
Una persona puede reunir varios roles. Los nombres de rol agrupan permisos; nunca son por sí mismos una decisión de autorización.
